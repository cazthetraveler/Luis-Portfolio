const projects = [
    {
        ...
        links: {
            repo: "",
            deployed: "https://www.behance.net/gallery/190078749/Weather-Dashboard-UI-Project"
        },
        image: {
            source: "https://github.com/cazthetraveler/Weather-Dashboard/raw/main/assets/images/desktop-screenshot.png",
    ...
    },
    {
        ...
        description: "A weather dashboard that displays current weather conditions and a five day forecast for a city.",
        links: {
    ...
    },
    {
        ...
        image: {
            source: "https://github.com/cazthetraveler/Coding-Quiz/raw/main/assets/images/screenshot.png",
    ...
    },
    {
        ...
        category: "web-dev",
        title: "Pixel Pets",
        description: "A simple virtual pet game made with model view controllers and NodeJS.",
        links: {
            repo: "https://github.com/cazthetraveler/Pixel-Pets",
            deployed: "https://pixel-pets-8842a450b767.herokuapp.com/"
        },
        image: {
            source: "https://github.com/cazthetraveler/Pixel-Pets/blob/main/public/images/pets/mouse/white/default.gif?raw=true",
    ...
    },
    {
        ...
        image: {
            source: "https://github.com/jameslwilson364/weeklyMoodal/raw/main/assets/images/Live-Screenshot.png",
    ...
    },
    {
        ...
        links: {
            repo: "",
            deployed: "https://www.behance.net/gallery/190447801/XTAL-Clothing-Co-Logo-Design-Project"
        },
        image: {
            source: "",
